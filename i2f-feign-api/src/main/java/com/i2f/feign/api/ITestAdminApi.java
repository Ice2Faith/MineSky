package com.i2f.feign.api;

import com.i2f.feign.api.fallback.TestAdminApiFallback;
 ...
 */
@FeignClient(value = "ui-admin",fallback = TestAdminApiFallback.class)
public interface ITestAdminApi {
    @GetMapping(value = "/admin/test/svc")
